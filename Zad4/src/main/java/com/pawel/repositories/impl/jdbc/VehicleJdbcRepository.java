...
public class VehicleJdbcRepository implements VehicleRepository {
    ...
    public Vehicle save(Vehicle vehicle) {
        ...
        Optional<Vehicle> vehicleFromTable = findById(vehicle.getId());
        if (vehicle.getId() == null || vehicle.getId().isBlank() || vehicleFromTable.isEmpty()) {
    ...
    public void addVehicle(Vehicle vehicle) {
        //TODO jesli bedzie trzeba to sie to zrobi. Moze sie uda wyrzucic z JsonRepo
    }
}
